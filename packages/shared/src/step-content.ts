  ...
  2: {
    ...
    methodology: {
      ...
      bestPractices: [
        ...
        'Use data to validate suspected root causes before moving to solutions',
      ],
      facilitationGuide:
  ...
  3: {
    ...
    methodology: {
      ...
      bestPractices: [
        ...
        'After idea generation, group similar ideas into themes without eliminating any',
  ...
  4: {
    ...
    methodology: {
      tips: [
        ...
        'Each task should have exactly one Accountable person in the RACI chart',
  ...
  6: {
    ...
    methodology: {
      tips: [
        ...
        'Decide explicitly: standardize, iterate, or start a new PIPS cycle',
      ],
      bestPractices: [
        ...
        'If goals were not fully met, treat this as input for the next PIPS cycle rather than a failure',
      ],
      facilitationGuide:
