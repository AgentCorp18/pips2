...
> **MVP: 100% COMPLETE** — Live at https://pips-app.vercel.app
>
> **Built and deployed:**
>
> - Auth (email/password, verification, password reset, sessions) — AUTH-01 through AUTH-03, AUTH-07, AUTH-10
> - Organization management (create, slug, settings, RLS isolation) — ORG-01 through ORG-04
> - RBAC (5 roles, API-level enforcement) — RBAC-01 through RBAC-04
> - Invitation system (email invite, accept, pending management) — INV-01 through INV-05
> - Team management (create, members, assign to projects) — TEAM-01 through TEAM-05, TEAM-07
> - User profiles (display name, email, avatar, notification prefs) — PROF-01, PROF-04
> - PIPS 6-step workflow (creation, stepper, gating, regression) — PROJ-01 through PROJ-05, WF-01 through WF-04
> - 18 of 26 digital forms functional — FORM-01 through FORM-21 (excluding FORM-03 Brainwriting, FORM-22 through FORM-25 Parking Lot variants, FORM-26 Tools Quick Guide)
> - Ticketing (PIPS + general, Kanban, list view, parent/child, comments, @mentions, activity log) — TKT-01 through TKT-11, TKT-14, TKT-17 through TKT-21, TKT-23
> - Dashboard with stat cards, projects-by-step chart, recent activity — DASH-01, DASH-03, PMET-01
> - Notifications (in-app bell, dropdown, mark-as-read, DB triggers) — NOTIF-01 through NOTIF-03, NOTIF-08, NOTIF-11
...
5. [Feature Requirements — Knowledge Hub](#5-feature-requirements--knowledge-hub)
6. [Feature Requirements — Training Mode](#6-feature-requirements--training-mode)
7. [Feature Requirements — Workshop Facilitation](#7-feature-requirements--workshop-facilitation)
8. [Adoption & Friction Mitigation Requirements](#8-adoption--friction-mitigation-requirements)
...
## 5. Feature Requirements — Knowledge Hub

> **Status:** Foundation COMPLETE. Reading experience, FTS, Cadence Bar, bookmarks operational. Workbook and contextual linking in progress.

The Knowledge Hub is the content ecosystem that makes PIPS 2.0 a learning platform, not just a project management tool. It embeds the full PIPS methodology (from "The Never-Ending Quest" book) into the product as searchable, contextual content that users encounter while doing their work.

### 5.1 Content Infrastructure

| ID    | Requirement                                                                                      | Priority | Status      |
| ----- | ------------------------------------------------------------------------------------------------ | -------- | ----------- |
| KH-01 | 205+ content nodes compiled from PIPS book, stored in `book_content` table                       | P0       | DONE        |
| KH-02 | Full-text search across all content nodes (Postgres FTS with tsvector)                           | P0       | DONE        |
| KH-03 | Content taxonomy: chapters, sections, topics with hierarchical navigation                        | P0       | DONE        |
| KH-04 | Content node metadata: step association, tool association, difficulty level, estimated read time | P0       | DONE        |
| KH-05 | Content versioning: track updates to content nodes without losing history                        | P1       | Not started |

### 5.2 Reading Experience

| ID    | Requirement                                                                     | Priority | Status                                                                       |
| ----- | ------------------------------------------------------------------------------- | -------- | ---------------------------------------------------------------------------- |
| KH-10 | Dedicated reading view with clean typography and distraction-free layout        | P0       | DONE                                                                         |
| KH-11 | Cadence Bar: contextual content widget integrated into step-view and dashboard  | P0       | DONE                                                                         |
| KH-12 | Bookmark system: save, list, and navigate to bookmarked content                 | P0       | DONE                                                                         |
| KH-13 | Reading progress tracking per user (which nodes read, percentage complete)      | P0       | DONE                                                                         |
| KH-14 | Content recommendations based on current PIPS step context                      | P1       | Partial — Cadence Bar provides step context, but no ML-based recommendations |
| KH-15 | Contextual "Learn More" links from PIPS forms to relevant Knowledge Hub content | P1       | Not started                                                                  |

### 5.3 Workbook & Practice

| ID    | Requirement                                                            | Priority | Status      |
| ----- | ---------------------------------------------------------------------- | -------- | ----------- |
| KH-20 | Workbook scaffolding: step-by-step practice mode with guided exercises | P1       | Scaffolded  |
| KH-21 | Workbook exercises linked to specific PIPS forms and tools             | P1       | Not started |
| KH-22 | Workbook progress tracking per user                                    | P1       | Not started |

### 5.4 Knowledge Hub Landing

| ID    | Requirement                                                            | Priority | Status      |
| ----- | ---------------------------------------------------------------------- | -------- | ----------- |
| KH-30 | Landing page with content categories, search bar, and quick navigation | P0       | DONE        |
| KH-31 | Content browsing by PIPS step (filter by step 1-6)                     | P0       | DONE        |
| KH-32 | Recently read and recommended content sections                         | P1       | Not started |

---

## 6. Feature Requirements — Training Mode

> **Status:** DB tables + seed data READY. Pages scaffolded. Wiring in progress.

Training Mode transforms PIPS 2.0 from a tool into a capability-building platform. Organizations invest in training progress that builds team competency over time.

### 6.1 Learning Paths

| ID    | Requirement                                                         | Priority | Status          |
| ----- | ------------------------------------------------------------------- | -------- | --------------- |
| TR-01 | 4 predefined learning paths with progressive difficulty             | P0       | Seed data ready |
| TR-02 | Path catalog page showing all available paths with descriptions     | P0       | Scaffolded      |
| TR-03 | Path detail page showing modules, progress, and next step           | P0       | Scaffolded      |
| TR-04 | Sequential module unlocking: complete module N before accessing N+1 | P1       | Not started     |
| TR-05 | Custom learning paths per organization (admin can create/edit)      | P2       | Not started     |

### 6.2 Modules & Exercises

| ID    | Requirement                                                                             | Priority | Status          |
| ----- | --------------------------------------------------------------------------------------- | -------- | --------------- |
| TR-10 | 27 modules across 4 learning paths                                                      | P0       | Seed data ready |
| TR-11 | 59 practice exercises with guided scenarios                                             | P0       | Seed data ready |
| TR-12 | Exercise types: fill-in-form (uses real PIPS forms), multiple choice, scenario analysis | P0       | Not started     |
| TR-13 | Sandbox projects for practice: isolated from real org data                              | P1       | Not started     |
| TR-14 | Exercise validation and feedback (correct/incorrect with explanations)                  | P0       | Not started     |
| TR-15 | Module completion tracking per user                                                     | P0       | Not started     |

### 6.3 Progress & Certification

| ID    | Requirement                                                    | Priority | Status      |
| ----- | -------------------------------------------------------------- | -------- | ----------- |
| TR-20 | Progress dashboard showing completion % per path and module    | P0       | Scaffolded  |
| TR-21 | Achievement badges on path completion                          | P1       | Not started |
| TR-22 | Team training report: admin can see team progress across paths | P1       | Not started |
| TR-23 | Certificate generation on path completion (PDF)                | P2       | Not started |

---

## 7. Feature Requirements — Workshop Facilitation

> **Status:** DB tables CREATED and applied to production. UI scaffolded.

Workshop Facilitation bridges consulting engagements and software. Facilitators can run live PIPS workshops inside the product with real-time participation.

### 7.1 Workshop Sessions

| ID    | Requirement                                                                                       | Priority | Status      |
| ----- | ------------------------------------------------------------------------------------------------- | -------- | ----------- |
| WS-01 | Create workshop session with title, description, facilitator, scheduled time, linked PIPS project | P0       | DB ready    |
| WS-02 | Workshop module catalog: pre-built facilitation modules per PIPS step                             | P0       | DB ready    |
| WS-03 | Session page with module list, timer, and participant roster                                      | P0       | Scaffolded  |
| WS-04 | Real-time participant joining via session link or code                                            | P1       | Not started |
| WS-05 | Facilitator controls: start/pause/end session, advance modules                                    | P0       | Not started |

### 7.2 Real-Time Facilitation

| ID    | Requirement                                                                         | Priority | Status      |
| ----- | ----------------------------------------------------------------------------------- | -------- | ----------- |
| WS-10 | Real-time updates via Supabase Realtime channels                                    | P0       | Not started |
| WS-11 | Timer system: countdown timers for timed activities (brainstorming, voting)         | P1       | Not started |
| WS-12 | Presentation mode: full-screen view of current module for projection/screen sharing | P1       | Not started |
| WS-13 | Participant contributions visible in real-time (ideas, votes, responses)            | P0       | Not started |
| WS-14 | Session outputs auto-saved to linked PIPS project forms                             | P1       | Not started |

### 7.3 Workshop Templates

| ID    | Requirement                                                             | Priority | Status      |
| ----- | ----------------------------------------------------------------------- | -------- | ----------- |
| WS-20 | Pre-built workshop templates for each PIPS step                         | P1       | Not started |
| WS-21 | Custom workshop template creation (facilitator can build agendas)       | P2       | Not started |
| WS-22 | Workshop history: completed sessions with outputs and participant lists | P1       | Not started |

---

## 8. Adoption & Friction Mitigation Requirements

> **Source:** Customer Insights Report (March 3, 2026). These requirements address the 8 friction risks identified by the Customer Insights Agent and should be prioritized for the beta launch.

### 8.1 Trial & Signup Flow

| ID     | Requirement                                                                                                                        | Priority | Status      | Friction Risk |
| ------ | ---------------------------------------------------------------------------------------------------------------------------------- | -------- | ----------- | ------------- |
| AFR-01 | "Try PIPS Free" CTA button on all marketing pages linking to /signup                                                               | P0       | Not started | F1, F8        |
| AFR-02 | Beta label: display "Beta — Free Access" on signup and dashboard. Do NOT promise 14-day trial until Stripe is integrated           | P0       | Not started | F1            |
| AFR-03 | Pricing interest page: "What plan is right for you?" collecting email + plan preference to validate pricing before building Stripe | P1       | Not started | F8            |

### 8.2 Onboarding & First-Value

| ID     | Requirement                                                                                                                | Priority | Status      | Friction Risk |
| ------ | -------------------------------------------------------------------------------------------------------------------------- | -------- | ----------- | ------------- |
| AFR-10 | Auto-create sample project on new org creation (not user-triggered). Label as "[Sample] Parking Lot Improvement Project"   | P0       | Not started | F7            |
| AFR-11 | Post-onboarding choice screen: "Explore Sample Project" vs "Create Your First Project"                                     | P0       | Not started | F2            |
| AFR-12 | 3-card methodology explainer shown before Step 1 on first project creation. Dismissible with "Don't show again" preference | P0       | Not started | F3            |
| AFR-13 | Invite-team prompt after first project creation                                                                            | P1       | Not started | F2            |

### 8.3 In-Workflow Guidance

| ID     | Requirement                                                                                                         | Priority | Status      | Friction Risk |
| ------ | ------------------------------------------------------------------------------------------------------------------- | -------- | ----------- | ------------- |
| AFR-20 | Mark 1-2 forms per step as "Recommended" with visual badge. Show tooltip: "Most teams start with [form name]"       | P0       | Not started | F6            |
| AFR-21 | Auto-expand Cadence Bar on first visit to each step. Collapse by default after first visit (track via localStorage) | P1       | Not started | F5            |
| AFR-22 | Contextual "Learn about this step" callout on first encounter with each PIPS step                                   | P1       | Not started | F5            |

### 8.4 Re-Engagement

| ID     | Requirement                                                                                      | Priority | Status      | Friction Risk |
| ------ | ------------------------------------------------------------------------------------------------ | -------- | ----------- | ------------- |
| AFR-30 | Verify and test all email notification paths: ticket assignment, @mention, project step advanced | P0       | Not started | F4            |
| AFR-31 | Daily digest email: summary of activity for users who have not logged in for 48+ hours           | P1       | Not started | F4            |
...
### 11.2 PIPS Project View (6-Step Workflow)
...
### 13.8 Webhooks and Integrations
...
```json
{
  ...
  "errors": [{ "field": "title", "message": "Required field", "code": "required" }]
}
```
...
### 14.11 Edge Cases and Error Handling
