...
const BrainwritingPage = async ({
  ...
  const saved = await loadFormData(projectId, stepNumber, 'brainwriting')

  return <BrainwritingForm projectId={projectId} stepNumber={stepNumber} initialData={saved} />
}

export default BrainwritingPage
