...
const ProblemStatementPage = async ({
  params,
}: {
  ...
  const saved = await loadFormData(projectId, stepNumber, 'problem_statement')

  return <ProblemStatementForm projectId={projectId} stepNumber={stepNumber} initialData={saved} />
}
